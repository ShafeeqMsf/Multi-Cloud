 ...
 * @author Vinayak
 */
public class ActivityMenu extends javax.swing.JFrame {
private String userName;
    /**
     * Creates new form ActivityMenu
     */
        public ActivityMenu(){
     ...
     */
    public static void main(final String uname) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActivityMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActivityMenu(uname).setVisible(true);
            }
        });
    }
