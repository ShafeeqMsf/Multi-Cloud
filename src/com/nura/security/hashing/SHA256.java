package com.nura.security.hashing;

import java.math.BigInteger;

/**
 * 
 * Always call hash class using new object
 */
public class SHA256 {
    ...
    public static void main(String[] args) {
        String s = "1111$001110010100000101101101001100000100111101100001010100100101100001010011011000100110111100110101011011000100111001001010010000010111001001101010011100110110000100110010010100010011110100111101";        
        SHA256 sha = new SHA256();        
        String str = sha.hash(s.getBytes());
        System.out.println("SHA256 : " + str);
        //SSystem.out.println("" + sha.hash(s.getBytes()));
    }
}
